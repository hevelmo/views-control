 ...
 */
(function() {
    jQuery.fn.jplist.ui.controls.ViewsDTO = function(d) {
        this.view = d
    }
})();
(function() {
    var d = function(a, b) {
        ...
        f = function(a) {
            a.params.$buttons.on("click", function() {
                ...
                a.$root.removeClass(a.params.types.join(" ")).addClass(b);
    ...
    e.prototype.getDeepLink = function() {
        var a = "",
            b;
        this.inDeepLinking && (b = d(this, !1), b.data &&
            (a = this.name + this.options.delimiter0 + "view=" + b.data.view));
        return a
    };
    e.prototype.getStatusByDeepLink = function(a, b) {
        var c = null;
        this.inDeepLinking && (c = d(this, !0), c.data.view = b);
        return c
    };
    e.prototype.setStatus = function(a, b) {
        a.data && (this.$root.removeClass(this.params.types.join(" ")), !this.inStorage && b ? (this.$root.addClass(this.params.defaultView), a.data.view = this.params.defaultView, this.params.currentView = this.params.defaultView, this.observer.trigger(this.observer.events.statusChanged, [a])) : (this.$root.addClass(a.data.view),
            this.params.currentView = a.data.view))
    };
